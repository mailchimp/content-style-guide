...
Our tone changes depending on the situation, but it is generally informal. We have a sense of humor, but we value clarity over entertainment.
...
- Do not use underline, and do not use any combination of italic, bold, caps, and underline.
...
- Use title case for **form titles** and sentence case for **form fields**. Only request information that we need and intend to use. Do not ask for irrelevant personal information, like gender.
...
- Provide a link whenever you are referring to a website, relevant content, and trusted external resources.
