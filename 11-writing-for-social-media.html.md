...
Our writing for social media should generally follow the style points outlined in the [Voice and tone](TK) and [Grammar and mechanics](TK) sections. Our content values hold true in our approach to social media, too.

Here are some additional pointers for writing for MailChimp social media. 
